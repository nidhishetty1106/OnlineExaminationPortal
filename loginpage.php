...
body {
  background:url(https://www.franchiseindia.com//uploads/content/edu/art/education-858cc07046.jpg) no-repeat;
  padding: 80px;
...
<body>
<h1><b>EXAMINATION FORM</b> </h1>
<form action="login1.php"  method="POST" >
    
  <label for=""></label>
  <input type="text" name="mail" id="mail" placeholder="email" class="email">
    
  <label for=""></label>
  <input type="password" name="pword" id="pword" placeholder="password" class="pass">
